               ...
               <div class="col-sm-12">
                ...
                <div class="acct_box blue_acct front">
                	<div class="acct_box_inn">
                        ...
                        <img src="<?php echo url();?>/public/frontend/images/account/pers_info.png" alt="">
                ...
                <div class="acct_box green_acct no_marg  pull-right">
                	<div class="acct_box_inn">
                    	<div class="acct_box_inn_inn">
                        <img src="<?php echo url();?>/public/frontend/images/account/changepassword.png" alt="">
                ...
                <div class="acct_box new_green_acct no_marg pull-right">
                	<div class="acct_box_inn">
                    	<div class="acct_box_inn_inn">
                        <img src="<?php echo url();?>/public/frontend/images/account/order_hist.png" alt="">
