              ...
              <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm-12">
                            ...
                            <div class="col-xs-6 tags_div pull-right">
                                <div class="row">
                                    <div class="row">
                                      <label class="col-sm-4">Feeling Tags</label>
                                        <div class="col-sm-8">
                                        <input type="text" name="filling_tags" id="filling_tags" value="" aria-invalid="false" class="valid">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-top: 5px;">
                                    <div class="row">
                                      <label class="col-sm-4">Ingredient Tags</label>
                                        <div class="col-sm-8">
                                        <input type="text" name="ingredient_tags" id="ingredient_tags" value="" aria-invalid="false" class="valid">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
var total_value = parseFloat(this_vald) * parseFloat($this.parent().parent().find('.get_val').val());
 ...
 // For Ingredient dropdown
  ...
  //console.log("No. Form Factor: "+no_count)
    $.ajax({
...
select_opt={};
    ...
    //console.debug("Debug: "+ JSON.stringify(select_opt) )

    // Updated on 10th Feb 2016: Display Ingredients in sorted order
...
function checktable_val(){
   ...
   $(document).ready(function(e) {
    ...
    console.log("Count Formfactor: "+no_count)
		...
		$('#formfactortable').append('<tr class="form_factore_info"><td><select class="form-control factorname ffactor" id="fac_'+count_formfactor+'" name="formfactor['+count_formfactor+'][formfactor_id]">'+total_opt+'</select></td><td><input class="form-control upcharge ffactor" id="upc_'+count_formfactor+'" type="text" name="formfactor['+no_count+'][upcharge]" placeholder="Upcharge" readonly></td><td><input class="form-control serv_text ffactor" id="ser_'+no_count+'" type="text" name="formfactor['+count_formfactor+'][servings]" placeholder="Servings" ></td><td><a href="javascript:void(0);" class="remove_row_formfactortable"><i class="fa fa-minus-square-o"></i></a></td><td><div class="optionBox"><div class="block" id="duration_block_'+no_count+'"><div class="Cell"><input type="text" class="duration ffactor" placeholder="Duration" id="dur_'+count_formfactor+'_0" name="formfactor['+count_formfactor+'][duration][]" /></div><div class="Cell"><input type="text" class="min_price ffactor" placeholder="Minimum Price" id="min_'+count_formfactor+'_0" name="formfactor['+count_formfactor+'][min_price][]"  /></div><div class="Cell"><input type="text" class="rec_price ffactor" placeholder="Recommended Price" id="rec_'+count_formfactor+'_0" name="formfactor['+count_formfactor+'][recommended_price][]" /></div><div class="Cell"><input type="text" class="actual_price ffactor" placeholder="Actual Price" id="act_'+count_formfactor+'_0" name="formfactor['+count_formfactor+'][actual_price][]"  /></div><span class="remove" onclick="removeDur('+count_formfactor+', 1)"><i class="fa fa-minus-square-o"></i></span></div><div class="block"><span class="addItem" onclick="addDur('+count_formfactor+')"><i class="fa fa-plus-square"></i> <b>Add</b></span></div></div></td></tr>');
		//no_count++;
		check_addrow();
...
// End of Custom Time Frame Calculations
  ...
  $("#product_form").validate({
        ...
        // 29-Jan-2016: Image text and description is not mandatory
        rules: {
        ...
        alert(check_weight_empty); 
        alert(groupnameflag); 
        alert(serv_textflag); */
    
    
    console.log("mflag: "+mflag);
    console.log("checkradiostate_var: "+checkradiostate_var);
  ...
  function calc_minval(upchargeval,servingval,thisobj){
    ...
    //alert("Inside calc "+$(thisobj).attr("input"))
    ...
    //alert(this_obj.parent().parent().find('.min_price').val())
  ...
  $(document).on('blur','.actual_price',function(){
    //alert(checkradiostate_var);
    /*
    // Commented out for CUSTOM TIME FRAME
    if(checkradiostate_var==true){
      var actual_prc=0, minimum_prc=0,
      $this=$(this);
