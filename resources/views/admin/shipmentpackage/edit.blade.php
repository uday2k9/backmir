...
// When the browser is ready...
	...
	{!! Form::model($ShipmentPackage,['method' => 'PATCH','id'=>'shipmentpackage_form','files'=>true,'class'=>'form-horizontal row-fluid','route'=>['admin.shipment-package.update',$ShipmentPackage->id]]) !!}
	...
	<div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                     ...
                     {!! Form::select('p_type',$parenttypesarray,$ShipmentPackage->p_type,['class'=>'span8','id'=>'p_type']) !!}
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls" id="typediv">
                     ...
                     {!! Form::select('type',$typesarray,$ShipmentPackage->type,['class'=>'span8','id'=>'type']) !!}
                </div>
            </div>
