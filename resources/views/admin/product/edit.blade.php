...
<div class="inner_page_container">        
   ...
   {!! Form::model($products,['method' => 'PATCH', 'files'=>true,'route'=>['admin.product.update',$products->id],'id'=>'product_form']) !!}
    ...
    <div class="row"><div class="add_product_panel">
                        ...
                        <div class="col-sm-12">
                          <div class=" total_price">
                            ...
                            <p class="text-right">Total Weight : 
                              ...
                              <input type="hidden" id="TotalIngredients" name="TotalIngredients" value="<?php echo count($all_ingredient) ?>">
                            </p>
                          </div>
                        </div>
                                ...
                                foreach ($pro_form_factor as $key => $value) 
                                {
                                  ...
                                  <tr class="form_factore_info">                              
                                      <td>
                                        ...
                                        <select class="form-control factorname ffactor" name="formfactor[<?php echo $k;?>][formfactor_id]" id="fac_<?php echo $k;?>">
                              ...
                              <p class="upload_image">
                               ...
                               <div class="selectedFiles">
                                ...
                                <?php } ?>
                                  ...
                                  <div class="col-sm-8 mar_top_bot mar_tag" ><div class="row"><div class="row"><label class="col-sm-3">Feeling Tags</label><div class="col-sm-9"><input type="text" name="filling_tags" id="filling_tags" value="<?php $ft="";
                                      ...
                                      echo $ft;
                                  ?>" aria-invalid="false" class="valid"></div></div></div><div class="row"><div class="row"><label class="col-sm-3">Ingredient Tags</label><div class="col-sm-9"><input type="text" name="ingredient_tags" id="ingredient_tags" value="<?php $it="";
                                      ...
                                      echo $it;
                                  ?>" aria-invalid="false" class="valid"></div></div></div></div>
  ...
  $("#product_form").validate({
		...
		if(checkradiostate_var==true){	
			...
			//alert('else:'+flag)	
				...
				$('.alert-danger').remove();
				if(emptyweight_checkfornonmiramix==false || (arr_dupvals.length)!=0 || flag==false || mflag==false || serv_textflag==false || groupnameflag==false){	
...
function checkFormfactorDurationValues() {
    ...
    for(i=0; i < min_prices.length; i++) {
     ...
     console.log("AA: "+ durval + " " +minprice + " " +recprice + " " +actprice);
