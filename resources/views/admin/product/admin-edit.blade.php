...
<?php //echo "<pre>";print_r($individual_total_count);exit; ?>
                          ...
                          <div class="upload_button_panel">
                            ...
                            <div class="selectedFiles">
                              <?php if($products->image1!="" && file_exists('uploads/product/'.$products->image1)) {?>
                                <img src="<?php echo url();?>/uploads/product/<?php echo $products->image1;?>" alt="" width="" />
                          ...
                          <div class="upload_button_panel">
                            ...
                            <div class="selectedFiles">
                              <?php if($products->image2!="" && file_exists('uploads/product/'.$products->image2)) {?>
                                <img src="<?php echo url();?>/uploads/product/<?php echo $products->image2;?>" alt="" width="" />
